...
export LD_LIBRARY_PATH="$BASE_DIR"/:"$BASE_DIR":$LD_LIBRARY_PATH
export QML_IMPORT_PATH="$BASE_DIR"/qml/:$QML_IMPORT_PATH
export QML2_IMPORT_PATH="$BASE_DIR"/qml/:$QML2_IMPORT_PATH
export QT_PLUGIN_PATH="$BASE_DIR"/:$QT_PLUGIN_PATH
export QTWEBENGINEPROCESS_PATH="$BASE_DIR"//QtWebEngineProcess
export QTDIR="$BASE_DIR"
export CQT_PKG_ROOT="$BASE_DIR"
export CQT_RUN_FILE="$BASE_DIR/WebWorkTracker.sh"

export QT_QPA_PLATFORM_PLUGIN_PATH="$BASE_DIR"//platforms:$QT_QPA_PLATFORM_PLUGIN_PATH



"$BASE_DIR/WebWorkTracker" "$@" 
